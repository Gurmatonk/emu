...
rlcHL gb =
  gb & gbCPU . cpuFlagC .~ old7th
    & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
    & gbCPU . cpuFlagZ .~ (newVal == 0x00)
    & gbCPU . cpuFlagN .~ False
    & gbCPU . cpuFlagH .~ False
  where
    newVal = oldVal `rotateL` 1
    oldVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM)
...
res0HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 0) .~ False

res1HL :: Gameboy -> Gameboy
res1HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 1) .~ False

res2HL :: Gameboy -> Gameboy
res2HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 2) .~ False

res3HL :: Gameboy -> Gameboy
res3HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 3) .~ False

res4HL :: Gameboy -> Gameboy
res4HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 4) .~ False

res5HL :: Gameboy -> Gameboy
res5HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 5) .~ False

res6HL :: Gameboy -> Gameboy
res6HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 6) .~ False

res7HL :: Gameboy -> Gameboy
res7HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 7) .~ False
...
set0HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 0) .~ True

set1HL :: Gameboy -> Gameboy
set1HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 1) .~ True

set2HL :: Gameboy -> Gameboy
set2HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 2) .~ True

set3HL :: Gameboy -> Gameboy
set3HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 3) .~ True

set4HL :: Gameboy -> Gameboy
set4HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 4) .~ True

set5HL :: Gameboy -> Gameboy
set5HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 5) .~ True

set6HL :: Gameboy -> Gameboy
set6HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 6) .~ True

set7HL :: Gameboy -> Gameboy
set7HL gb = gb & writeToRam (gb ^. gbCPU . cpuRegisterHL) newVal
  where
    newVal = ramLookup' (gb ^. gbCPU . cpuRegisterHL) (gb ^. gbRAM) & bitwiseValue (bit 7) .~ True